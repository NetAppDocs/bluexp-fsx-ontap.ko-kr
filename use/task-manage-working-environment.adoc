...
summary: Cloud Manager를 사용하면 ONTAP 작업 환경을 위한 FSx를 관리할 수 있습니다. 처리량과 스토리지 용량 및 IOPS를 변경하고 작업 환경을 제거 또는 삭제할 수 있습니다. 
---
...
[role="lead"]
Cloud Manager를 사용하면 ONTAP 작업 환경을 위한 FSx를 관리할 수 있습니다. 처리량과 스토리지 용량 및 IOPS를 변경하고 작업 환경을 제거 또는 삭제할 수 있습니다.
...
. Cloud Manager에서 ONTAP용 FSx를 제거하려면 * 제거 * 를 선택합니다.
